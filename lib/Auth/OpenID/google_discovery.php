...
class GApps_OpenID_Discovery
{
    ...
    public $host_meta_template = 'https://www.google.com/accounts/o8/.well-known/host-meta?hd=%s';
     ...
     */
    public function discover($url, $fetcher)
    {
        try {
     ...
     * @return str
     */
    public function fetch_host_meta($domain, $fetcher)
    {
     ...
     * @return aray(str)
     */
    public function get_user_xrds_url($xrds, $claimed_id)
    {
     ...
     */
    public function put_cache($key, $value)
    {
        if ($this->memcache != null) {
...
class GApps_OpenID_SimpleSign
{
     ...
     */
    public function GApps_OpenID_SimpleSign($trust_roots = null)
    {
     ...
     * @return bool
     */
    public function validate_xml($xpath)
    {
     ...
     * @return array(str)
     */
    public function parse_certificates($xpath)
    {
     ...
     * @return str
     */
    public function save_cert_chain($certs)
    {
        $chain = implode("", $certs);
    ...
    public function validate_chain($certs)
    {
